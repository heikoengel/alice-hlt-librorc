...
namespace LIBRARY_NAME
{
    ...
    siu::linkOpen()
    {
        ...
        return ((m_link->DDL(RORC_REG_DDL_CTRL)>>5) & 1);
    }
    ...
    {
        return ((m_link->DDL(RORC_REG_DDL_CTRL)>>29) & 1)==1;
    }

    bool
    siu::isInterfaceFifoFull()
    {
        return ((m_link->DDL(RORC_REG_DDL_CTRL)>>28) & 1)==1;
    }

    bool
    siu::isSourceEmpty()
    {
        return ((m_link->DDL(RORC_REG_DDL_CTRL)>>30) & 1)==1;
    }
