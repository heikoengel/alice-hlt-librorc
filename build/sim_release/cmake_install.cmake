...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES
    "/mnt/data/005_git/crorc-driver-dma/build/sim_release/librorc.so.1.0.1"
    "/mnt/data/005_git/crorc-driver-dma/build/sim_release/librorc.so.0"
    "/mnt/data/005_git/crorc-driver-dma/build/sim_release/librorc.so"
    )
  FOREACH(file
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/librorc.so.1.0.1"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/librorc.so.0"
...
IF(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  INCLUDE("/mnt/data/005_git/crorc-driver-dma/build/sim_release/src/cmake_install.cmake")
  INCLUDE("/mnt/data/005_git/crorc-driver-dma/build/sim_release/fli/cmake_install.cmake")
  INCLUDE("/mnt/data/005_git/crorc-driver-dma/build/sim_release/tools_src/cmake_install.cmake")
...
FILE(WRITE "/mnt/data/005_git/crorc-driver-dma/build/sim_release/${CMAKE_INSTALL_MANIFEST}" "")
FOREACH(file ${CMAKE_INSTALL_MANIFEST_FILES})
  FILE(APPEND "/mnt/data/005_git/crorc-driver-dma/build/sim_release/${CMAKE_INSTALL_MANIFEST}" "${file}\n")
ENDFOREACH(file)
